...
const translations = {
  ckb: {
    ...
    heroDesc: "سیستەمێکی پێشکەوتووی OCR و پڕۆسێسکردنی بەڵگەنامە بە هاوکاریی مۆدێلەکانی بینین و زمان (VLM) بۆ گۆڕینی پەڕەکان بۆ دەقی دیجیتاڵی، دەرهێنانی زانیاری و گەڕانی ماناوی.",
    heroTags: ["سۆرانی & کرمانجی", "دەرهێنانی زانیاری & ناسنامەکان", "Semantic Search"],
    ...
    ragTitle: "پرسیارکردن لە بەڵگەنامەکە (Semantic Q&A)",
  ...
  en: {
    ...
    heroTags: ["Sorani & Kurmanji", "Metadata & Entity Extraction", "Semantic Search"],
    ...
    ragTitle: "Ask the Document (Semantic Q&A)",
    aiAnswer: "AI Answer:",
